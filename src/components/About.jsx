          ...
          <div className="w-full md:w-2/3 flex flex-col justify-center gap-6">
            ...
            <div>
              ...
              <div className="text-[#a0a0a0] leading-relaxed max-w-2xl font-sans text-sm sm:text-base">
                <p>
                  Full Stack Developer and Computer Science and Business Systems student passionate about building modern, scalable web applications. I specialize in developing responsive and user-friendly interfaces using React, along with efficient backend systems using Node.js and databases like MongoDB.
                </p>
              </div>
            </div>
